...
faq:
  - question: "Comment obtenir un risotto crémeux sans être trop liquide ?"
    answer: "La clé est d'ajouter le bouillon petit à petit, à température ambiante, et de remuer fréquemment. Le dernier ajout de bouillon doit être légèrement sous-dosé — la texture finale doit rester 'vagabonde' (all'onda), c'est-à-dire ni compacte ni liquide."
  - question: "Quel vin utiliser pour le risotto ?"
    answer: "Un vin blanc sec et fruité fonctionne parfaitement. Évitez les vins trop acidity ou lesicodeùrs. Le bouillon de poulet ou de légumes remplace avantageusement le vin si vous cuisinez sans alcool."
...
featuredImageAlt: "Risotto crémeux aux champignons et parmesan dans une assiette"
...
ingredients:
  ...
  - "300g de champignons mélangés (girolles, chanterelles, paris)"
  - "100g de parmesan Reggiano aged 24 mois"
  - "1 oignon blanc"
  - "2 gousses d'ail"
  - "1,2L de bouillon de poulet ou légumes chaud"
  ...
  - "20g de beurre pour la finitions"
nutrition:
  calories: "520 kcal"
  protein: "18g"
  carbs: "65g"
...
steps:
  - name: "Préparation du bouillon et des champignons"
    text: "Portez le bouillon à frémissement doux dans une casserole separate. Nettoyez les champignons avec un pinceau sec et coupez-les en morceaux de taille uniforme. Dans une grande sauteuse, faites revenir les champignons 4-5 minutes à feu vif sans matière grasse — ils doivent dorer et perdre leur eau. Réservez."
  - name: "Sueur de l'oignon"
    text: "Dans la même sauteuse, ajoutez l'huile d'olive à feu moyen. Ajoutez l'oignon haché et faites-le revenir 5 minutes jusqu'à ce qu'il devienne translucide et tendre. Ajoutez l'ail, le thym et le laurier. Poursuivez 2 minutes."
  - name: "Tostatura del riso"
    text: "Incorporez le riz et touillez-le 2-3 minutes à feu moyen jusqu'à ce que les grains deviennent translucides sur les bords tout en restant opaques au centre. Vous devez entendre un léger crépitement — c'est la 'tostatura', cette étape cruciale qui scelle l'amidon et prépare la吸收 du liquide."
  - name: "Déglaçage et cuisson progressive"
    text: "Versez le vin blanc et remuez vigoureusement jusqu'à absorption complète. Commencez à ajouter le bouillon chaud, une louche à la fois, en remuant constamment. Attendez que chaque louche soit presque absorbée avant d'ajouter la suivante. Cela prend environ 15-18 minutes."
  - name: "Mantecatura : la touche finale"
    text: "Quand le riz est al dente et la texture 'vagabonde', retirez du feu. Éliminez le thym et le laurier. Ajoutez le beurre froid coupé en dés et le parmesan râpé. Remuez vigoureusement pendant 2 minutes — c'est la 'mantecatura' qui emulsifie les matières grasses et crée la texture crémeuse caractéristique."
  - name: "Reposo et service"
    text: "Laissez reposer 2 minutes. Le risotto doit être fluide, brillant, et former un 'cratère' au centre de l'assiette quand vous la inclinez. Répartissez dans des assiettes chaudes, garnissez des champignons réservés, et servez immédiatement avec un filet d'huile d'olive et une tournée de parmesan."
variations:
...
Découvrez comment les [traditions culinaires italiennes se transmettent et s'adaptent](/blog/articles/traditions-culinaires-ere-numerique/) dans notre monde moderne.

## Le choix du riz : la foundation absolutamente
...
Pour approfondir la qualité des ingrédients en cuisine, lisez notre article sur l'[histoire des épices et leur impact sur la gastronomie](/blog/articles/histoire-epices/).
...
Pour ceux qui souhaitent explorer d'autres préparation de champignons, notre [bao buns végan](/blog/recettes/bao-buns-vegan/) offrent une approche complètement différente avec les mêmes ingrédients.
...
Pour une alternative plus légère, découvrez notre [salade quinoa aux légumes grillés](/blog/recettes/salade-quinoa-legumes-grilles/), ou explorez les [équipements connectés qui transforment la cuisine](/blog/articles/technologies-transforment-cuisine/). Le risotto est aussi une recette anti-gaspi par excellence : champignons un peu vieillissants, restes de parmesan ou de vin blanc — tout trouve sa place dans ce plat. Pour aller plus loin sur la cuisine zéro déchet, notre [guide contre le gaspillage alimentaire](/blog/articles/gaspillage-alimentaire/) vous donnera des astuces concrètes. Et pour rester dans la cuisine italienne, notre [pizza chèvre-miel maison](/blog/recettes/pizza-chevre-miel/) est une autre façon élégante de célébrer le terroir transalpin.
