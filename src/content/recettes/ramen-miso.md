---
faq:
  - question: "Comment faire un bouillon de ramen sans dashi de poisson ?"
    answer: "Le kombu (algue) et les champignons shiitake créent un umami végétal puissant. Faites infuser le kombu à froid pendant 2h, puis portez à frémissement. Les shiitakes séchés ajoutent de la profondeur et ce goût fumé caractéristique."
  - question: "Quelle pâte utiliser pour les nouilles maison ?"
...
description: "Bouillon umami au miso blanc, shiitake et nouilles maison : un ramen végan qui rivalise avec les meilleures adresses. Long à préparer, mais spectaculaire."
descriptionLong: "Le ramen au miso de Bytemeuh : un bouillon végétal d'une grande complexité, créé par l'alliance du kombu, des shiitakes et du miso blanc, servi avec des nouilles maison et des toppings généreux. Un bol réconfortant qui réchauffe de l'intérieur."
...
steps:
  - name: "Préparation du bouillon dashi végétal"
    text: "Rincez rapidement le kombu et essuyez-le. Placez-le dans une casserole avec 1,5L d'eau froide. Portez très lentement à frémissement (sans faire bouillir) — cela prend 20-25 minutes. Retirez le kombu à 60°C et éteignez le feu. Ajoutez les shiitakes séchés et laissez infuser 30 minutes minimum. Filtrez et conservez le liquide — c'est votre base."
  ...
  - name: "Préparation des nouilles maison"
    text: "Mélangez la farine et le sel. Ajoutez l'eau progressivement en pétrissant 10 minutes jusqu'à obtenir une pâte lisse et élastique. Enveloppez dans un film et laissez reposer 40 minutes. Étalez au laminoir ou au rouleau à 2-3mm d'épaisseur. Découpez en lanières de 3mm de large. Farinez légèrement et réservez sur un plateau fariné."
  - name: "Cuisson du bouillon et assemblage"
    text: "Remettez le bouillon filtré à feu moyen. Ajoutez 2 c.à.s de tare et remuez. Goûtez et ajustez — le bouillon doit être salé, umami, avec une note de miso présente. Maintenez à frémissement doux. Faites cuire les nouilles fraîches 2-3 minutes dans une eau bouillante non salée. Égouttez et répartissez immédiatement dans 4 bols."
  - name: "Dressage final"
    text: "Versez le bouillon chaud sur les nouilles (elles doivent être presque entièrement immergées). Garnissez avec les germes de soja, le tofu coupé en dés et poêlé, les oignons verts ciselés, un filet d'huile de sésame, et les graines de sésame. Ajoutez quelques feuilles de nori et servez immédiatement."
variations:
...
Les [technologies qui transforment la cuisine](/blog/articles/technologies-transforment-cuisine/) jouent désormais un rôle dans l'évolution du ramen : les nouilles lyophilisées, les bouillons instantanés de qualité restaurant, et même les machines à ramen autonomes dans les gares japonaises.
...
Pour une comparaison avec d'autres techniques de bouillon, découvrez comment l'[histoire des épices](/blog/articles/histoire-epices/) révèle les mêmes principes de construction des saveurs.
...
Pour les curieux, explorez la technique derrière les [traditions culinaires transmises de génération en génération](/blog/articles/traditions-culinaires-ere-numerique/) — le tare illustre exactement ce concept : une recette affinée au fil des décennies, rarement écrite, le plus souvent transmise par la pratique.
...
Découvrez d'autres bols nourrissants dans notre collection végétale : le [poke bowl végan](/blog/recettes/poke-bowl-vegan/) partage cette philosophie du bol complet, les [bao buns au jack-fruit](/blog/recettes/bao-buns-vegan/) offrent une autre façon de cuisiner à la vapeur, tandis que la [salade de quinoa et légumes grillés](/blog/recettes/salade-quinoa-legumes-grilles/) propose une alternative fraîche et protéinée. Le [curry de légumes](/blog/recettes/curry-legumes/) reste une alternative plus établie mais tout aussi réconfortante.
