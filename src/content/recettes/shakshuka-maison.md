---
faq:
  - question: "Le shakshuka est-il un plat du matin ou du soir ?"
    answer: "Les deux ! Au Moyen-Orient et en Afrique du Nord, il se mange aussi bien au petit-déjeuner qu'au dîner. En France, il s'est imposé comme un brunch festif parfait."
  - question: "Comment savoir si les œufs sont cuits à point dans le shakshuka ?"
    answer: "Les blancs doivent être bien pris et opaques, les jaunes encore tremblotants si vous les aimez coulants. Couvrez la poêle 5-7 min à feu doux pour une cuisson uniforme."
  - question: "Peut-on préparer la base de tomates à l'avance ?"
    answer: "Absolument. La sauce mijotée se conserve 3 jours au réfrigérateur. Réchauffez-la, creusez des nids et ajoutez les œufs frais juste avant de servir."
...
ingredients:
  ...
  - "½ c.à.c de harissa (ou piment de Cayenne)"
  - "½ c.à.c de coriandre moulue"
  - "3 c.à.s d'huile d'olive"
  - "Sel et poivre du moulin"
  - "1 bouquet de persil ou coriandre fraîche"
  - "Pain pita ou pain de campagne pour servir"
nutrition:
  calories: "280 kcal"
  protein: "16g"
  carbs: "22g"
...
steps:
  - name: "Préparation des légumes"
    text: "Émincez finement l'oignon et l'ail. Coupez les poivrons en petits dés après les avoir épépinés."
  - name: "Faire revenir les aromates"
    text: "Dans une grande poêle à bords hauts ou une cocotte, faites chauffer l'huile d'olive à feu moyen. Ajoutez l'oignon et faites-le revenir 5 minutes. Ajoutez l'ail, le cumin, le paprika fumé, la coriandre moulue et la harissa. Faites revenir 1 minute en remuant."
  - name: "Cuisson des poivrons"
    text: "Incorporez les poivrons en dés. Faites cuire 5 minutes à feu moyen jusqu'à ce qu'ils soient légèrement ramollis."
  - name: "Préparation de la sauce tomate"
    text: "Versez les tomates concassées. Salez, poivrez. Mélangez bien et laissez mijoter à feu doux pendant 15-20 minutes en remuant de temps en temps, jusqu'à ce que la sauce épaississe et se concentre."
  - name: "Pocher les œufs"
    text: "Avec le dos d'une cuillère, creusez 6 cavités dans la sauce. Cassez délicatement un œuf dans chaque cavité. Couvrez la poêle et laissez cuire à feu doux 6-8 minutes selon la cuisson souhaitée : jaune coulant (6 min) ou bien pris (8-10 min)."
  - name: "Servir"
    text: "Parsemez généreusement de persil ou de coriandre fraîche hachée. Servez directement dans la poêle, avec du pain pita chaud ou du pain de campagne pour saucer la sauce."
variations:
...
La shakshuka, c'est l'un de ces plats qui réunit tout ce qu'on aime : un seul ustensile, des ingrédients simples et accessibles, une préparation rapide, et un résultat visuellement spectaculaire qui impressionne à chaque fois. Ces œufs pochés dans une sauce tomate richement épicée ont ce pouvoir rare de convenir aussi bien au brunch du dimanche qu'au dîner de semaine express. Découvrez comment la [cuisine saine et gourmande](/blog/articles/cuisine-saine-et-gourmande/) peut s'inviter chaque jour dans votre assiette sans compromis sur le goût.
