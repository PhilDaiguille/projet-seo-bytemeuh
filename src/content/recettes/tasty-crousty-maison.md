---
faq:
  - question: "Comment conserver un Tasty Crousty maison ?"
    answer: "Le riz et le poulet se conservent séparément au réfrigérateur jusqu'à 2 jours. Pour réchauffer, passez le poulet frit 5 minutes au four à 180 °C pour retrouver le croustillant, et réchauffez le riz à la poêle avec un filet d'eau."
  - question: "Quelle sauce utiliser pour un Tasty Crousty authentique ?"
    answer: "La sauce signature des Tasty Crousty est généralement une sauce crémeuse épicée, souvent à base de mayonnaise, sriracha, ail et citron. Vous pouvez aussi faire une version yaourt grec pour une option plus légère."
  - question: "Peut-on cuire le poulet au four plutôt que de le frire ?"
...
cuisine: "Française"
tags: ["tasty crousty", "riz poulet frit sauce", "fast-food maison"]
featuredImage: "../../assets/images/tasty-crousty-maison.webp"
featuredImageAlt: "Bowl de Tasty Crousty maison avec riz basmati, poulet frit croustillant et sauce crémeuse épicée"
ogImage: "https://bytemeuh.phildaiguille.fr/assets/images/tasty-crousty-maison.webp"
prepTime: "PT20M"
cookTime: "PT25M"
totalTime: "PT45M"
...
difficulty: "Facile"
ingredients:
  - "2 hauts de cuisse de poulet désossés (ou 2 escalopes de poulet)"
  - "200g de riz basmati"
  ...
  - "Sel et poivre"
  - "Huile pour la friture (ou friture à l'air)"
  - "3 c.à.s de mayonnaise légère"
  - "1 c.à.s de sriracha (ou sauce piquante)"
...
tips:
  ...
  - "Pour une version encore plus healthy, utilisez une friteuse à air chaud (air fryer) à 200 °C pendant 15-18 minutes en retournant à mi-cuisson."
steps:
  - name: "Cuisson du riz"
    text: "Rincez le riz basmati plusieurs fois à l'eau froide jusqu'à ce que l'eau soit claire. Faites-le cuire dans 400 ml d'eau salée selon les indications du paquet (environ 12 min à couvert à feu doux). Laissez gonfler 5 minutes hors du feu, couvert."
  - name: "Préparation de la sauce"
    text: "Dans un bol, mélangez la mayonnaise, la sriracha, le jus de citron, l'ail râpé et le miel. Goûtez et ajustez le piquant selon votre goût. Réservez au frais."
  - name: "Panage du poulet"
    text: "Préparez trois assiettes : farine assaisonnée de sel et poivre, œuf battu, chapelure panko mélangée au paprika, ail en poudre et oignon en poudre. Passez chaque morceau de poulet dans la farine, puis dans l'œuf, puis dans le panko en pressant bien."
  - name: "Friture du poulet"
    text: "Faites chauffer une bonne couche d'huile dans une poêle profonde à feu moyen-vif (environ 170 °C). Faites frire les morceaux de poulet 5-6 minutes de chaque côté jusqu'à ce qu'ils soient bien dorés et cuits à cœur. Égouttez sur du papier absorbant."
  - name: "Assemblage"
    text: "Dans des bols ou des boîtes, déposez une belle portion de riz basmati. Coupez le poulet frit en morceaux et disposez-le sur le riz. Nappez généreusement de sauce épicée. Servez immédiatement."
variations:
  - "Remplacez la mayonnaise par du yaourt grec pour une sauce plus légère et plus protéinée."
  - "Ajoutez des légumes cuits vapeur (brocoli, maïs, carottes) pour un bowl encore plus complet."
  - "Version épicée : doublez la dose de sriracha et ajoutez des jalapeños marinés sur le dessus."
---

Le Tasty Crousty, c'est LE plat qui fait fureur depuis quelques mois dans les fast-foods français et belges : un bowl généreux de riz, du poulet frit bien croustillant, et une sauce qui fait toute la différence. Bonne nouvelle — c'est encore meilleur fait maison, et bien plus sain. Si vous aimez les plats en bowl faciles à assembler, notre [poke bowl vegan](/blog/recettes/poke-bowl-vegan/) devrait aussi vous plaire.
...
Pour d'autres plats gourmands façon bowl ou street food maison, retrouvez nos [bao buns vegan](/blog/recettes/bao-buns-vegan/), notre [ramen miso](/blog/recettes/ramen-miso/) et nos [tacos de bœuf épicés](/blog/recettes/tacos-boeuf/).
