...
faq:
  - question: "Combien de nourriture est réellement gaspillée en France chaque année ?"
    answer: " Environ 10 millions de tonnes par an en France, dont 30 % au niveau des consommateurs. Cela représente 150kg par personne et par an — dont 20kg encore consommables jetés directement à la poubelle."
  - question: "Quel est le geste le plus efficace pour réduire le gaspillage à la maison ?"
    answer: "Le meal planning (planification des repas) réduit de 30 % le gaspillage domestique. Écrire une liste de courses et s'y tenir évite les achats impulsifs qui finissent par périmer."
...
category: "Durabilité"
tags: ["gaspillage alimentaire", "zero waste", "cuisine durable", "économie"]
featuredImage: "../../assets/images/gaspillage-alimentaire.webp"
featuredImageAlt: "Réduction du gaspillage alimentaire en cuisine"
...
Découvrez comment nos recettes s'inscrivent dans cette logique anti-gaspi : le [curry de légumes](/blog/recettes/curry-legumes/) est parfait pour consumer des légumes qui approchent, et le [risotto aux champignons](/blog/recettes/risotto-champignons/) rescue everything from slightly older mushrooms.
...
Explorez notre collection de recettes pensée pour utiliser les restes : le [poke bowl végan](/blog/recettes/poke-bowl-vegan/) intégrant parfaitement le riz refroidi et les légumes du réfrigérateur, ou la [ratatouille provençale](/blog/recettes/ratatouille-provencale/) qui célèbre les légumes un peu défraîchis.
...
En cuisine professionnelle, les équipements connectés permettent désormais un inventory management précis : capteurs de température en temps réel, balances intelligentes qui trackent les sorties, logiciels de prévision de production based on historical data. Ces technologies, que nous détaillons dans notre article sur les [équipements connectés en cuisine](/blog/articles/technologies-transforment-cuisine/), deviennent progressivement accessibles au grand public.
