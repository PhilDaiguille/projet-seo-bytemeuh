---
faq:
  - question: "Combien de nourriture est réellement gaspillée en France chaque année ?"
    answer: "Environ 10 millions de tonnes par an en France, dont 30 % au niveau des consommateurs. Cela représente 150 kg par personne et par an — dont 20 kg encore parfaitement consommables, jetés directement à la poubelle."
  - question: "Quel est le geste le plus efficace pour réduire le gaspillage à la maison ?"
    answer: "La planification des repas réduit de 30 % le gaspillage domestique. Écrire une liste de courses fondée sur des menus concrets et s'y tenir évite les achats impulsifs qui finissent par périmer."
  - question: "Les dates de péremption sont-elles toutes obligatoires ?"
    answer: "La DLC (Date Limite de Consommation) est obligatoire pour les produits périssables et indique un risque sanitaire — ne pas dépasser. La DLUO (Date de Durabilité Minimale) indique la qualité optimale, pas un risque : les produits peuvent être consommés après cette date si leur apparence et leur odeur sont normales."
...
Pour comprendre le contexte plus large, lisez notre article sur le [développement durable et l'alimentation](/blog/articles/developpement-durable-alimentation/), qui replace le gaspillage alimentaire dans une perspective systémique.
...
Nos recettes s'inscrivent naturellement dans cette logique anti-gaspi : le [curry de légumes](/blog/recettes/curry-legumes/) est parfait pour valoriser des légumes qui approchent de leur fin, et le [risotto aux champignons](/blog/recettes/risotto-champignons/) transforme les champignons légèrement vieillissants en un plat élégant.
...
Pour approfondir la compréhension des étiquettes et de la chaîne alimentaire, notre article sur les [technologies qui transforment la cuisine](/blog/articles/technologies-transforment-cuisine/) explore comment les outils modernes nous aident à mieux gérer nos provisions.
...
Explorez notre collection de recettes naturellement anti-gaspi : le [poke bowl végan](/blog/recettes/poke-bowl-vegan/) intègre parfaitement le riz refroidi et les légumes du fond du réfrigérateur, et la [ratatouille provençale](/blog/recettes/ratatouille-provencale/) célèbre les légumes d'été légèrement défraîchis.
